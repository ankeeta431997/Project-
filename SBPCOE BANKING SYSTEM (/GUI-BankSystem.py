...
def Cr_Amt(accnt,name):
	...
	l_title=tk.Message(creditwn,text="SBPCOE BANK",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
...
def De_Amt(accnt,name):
	...
	debitwn.configure(bg="#FFDAC9")
	fr1=tk.Frame(debitwn,bg="blue")
	l_title=tk.Message(debitwn,text="BANK SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="Dark Blue",justify="center",anchor="center")
...
def disp_tr_hist(accnt):
	disp_wn=tk.Tk()
	disp_wn.geometry("768x500")
	disp_wn.title("Transaction History")
	disp_wn.configure(bg="#FFDAC9")
	fr1=tk.Frame(disp_wn,bg="blue")
	l_title=tk.Message(disp_wn,text="Transaction History",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="DARK green",justify="center",anchor="center")
	l_title.config(font=("Times New Roman","50","bold"))
	l_title.pack(side="top")
...
def logged_in_menu(accnt,name):
	...
	rootwn.title("SBPCOE BANK-"+name)
	rootwn.configure(background='#FFDAC9')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	l_title=tk.Message(rootwn,text="STUDENT BANKING\n SYSTEM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="DARK RED",justify="center",anchor="center")
	l_title.config(font=("Times New Roman","50","bold"))
	l_title.pack(side="top")
...
def log_in(master):
	master.destroy()
	loginwn=tk.Tk()
	loginwn.geometry("768x320")
	loginwn.title("Log in")
	loginwn.configure(bg="#00F3FF")
	fr1=tk.Frame(loginwn,bg="blue")
	l_title=tk.Message(loginwn,text="BANKING SYSTEM (Log In)",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="red",justify="center",anchor="center")
	l_title.config(font=("Times New Roman","25","bold"))
	l_title.pack(side="top")
...
def Create():
	...
	crwn=tk.Tk()
	crwn.geometry("768x320")
	crwn.title("Create Account")
	crwn.configure(bg="ORANGE")
	fr1=tk.Frame(crwn,bg="blue")
	l_title=tk.Message(crwn,text="BANKING SYSTEM (Create Account)",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="red",justify="center",anchor="center")
	l_title.config(font=("Times New Roman","25","bold"))
	l_title.pack(side="top")
